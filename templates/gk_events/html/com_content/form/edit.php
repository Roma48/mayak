...
<form action="<?php echo JRoute::_('index.php?option=com_content&a_id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
	...
	<fieldset>
		<legend><?php echo JText::_('COM_CONTENT_IMAGES_AND_URLS'); ?></legend>
			...
			<?php echo str_replace('icon-remove', 'fa fa-ban',$this->form->getInput('image_intro', 'images')); ?>
			</div>
			...
			<?php echo str_replace('icon-remove', 'fa fa-ban',$this->form->getInput('image_fulltext', 'images')); ?>
			</div>
			<div style="clear:both"></div>
			<div class="formelm">
	...
	<?php if ($this->item->params->get('access-change')): ?>
		...
		<?php echo str_replace('icon-calendar', 'fa fa-calendar',$this->form->getInput('publish_up')); ?>
		</div>
		<div class="formelm">
		<?php echo $this->form->getLabel('publish_down'); ?>
				<?php echo str_replace('icon-calendar', 'fa fa-calendar',$this->form->getInput('publish_down')); ?>
		</div>
