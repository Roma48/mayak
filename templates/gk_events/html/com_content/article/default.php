...
<article class="item-page itemView <?php echo $this->pageclass_sfx?>" itemscope itemtype="http://schema.org/Article">
  ...
  <div class="item-info">
  	...
  	<time datetime="<?php echo JHtml::_('date', $this->item->publish_up, JText::_(DATE_W3C)); ?>" itemprop="datePublished">
  		<?php echo JHTML::_('date', $this->item->publish_up, 'D j M, Y'); ?>
  	</time>
  	...
  	<ul>
  		...
  		<li class="itemHits"><meta itemprop="interactionCount" content="UserPageVisits:<?php echo $this->item->hits; ?>" />
  								<?php echo JText::sprintf('COM_CONTENT_ARTICLE_HITS', $this->item->hits); ?></li>
  		<?php endif; ?>
  	</ul>
  	<?php endif; ?>
  </div>
  ...
  <div class="item-content<?php if($condition_info): ?> has-info<?php else: ?> no-info<?php endif; ?><?php if($condition_meta): ?> has-meta<?php else: ?> no-meta<?php endif; ?>">
  ...
  <?php if($condition_meta) : ?>       
  <div class="item-meta">
  	<?php if ($params->get('show_modify_date')) : ?>
  	<time datetime="<?php echo JHtml::_('date', $this->item->modified, JText::_(DATE_W3C)); ?>" itemprop="dateModified"><?php echo JText::_('TPL_GK_LANG_MODIFIED_AT'); ?><?php echo JHtml::_('date', $this->item->modified, 'D j M Y'); ?></time>
  	<?php endif; ?>
