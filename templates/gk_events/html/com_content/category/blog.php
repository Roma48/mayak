...
?>
<section class="category blog<?php echo $this->pageclass_sfx;?>" itemscope itemtype="http://schema.org/Blog">
	<?php 
		if(
	...
	<div class="leading" itemprop="blogPost" itemscope itemtype="http://schema.org/BlogPosting">
