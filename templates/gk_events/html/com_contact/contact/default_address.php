...
<div class="contact-contactinfo">
          ...
          <div><span class="<?php echo $this->params->get('marker_class'); ?>"> <?php echo $this->params->get('marker_email'); ?> </span> <span class="contact-emailto"  itemprop="email"> <?php echo $this->contact->email_to; ?> </span></div>
          <?php endif; ?>
