...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" >
          <fieldset class="userdata">
                    <p>
                              <input id="modlgn-username" type="text" name="username" class="inputbox"  size="24" placeholder="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME') ?>" />
                    </p>
                    <p>
                              <input id="modlgn-passwd" type="password" name="password" class="inputbox" size="24" placeholder="<?php echo JText::_('JGLOBAL_PASSWORD') ?>" />
                    </p>
