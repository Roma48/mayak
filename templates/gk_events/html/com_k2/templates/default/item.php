...
<article id="k2Container" class="itemView<?php echo $k2ContainerClasses; ?>"> 
    ...
    <header>
              ...
              <?php if($params->get('itemTitle')): ?>
	              ...
	              <small>
	              	 ...
	              	 <?php if($params->get('itemCategory') || $params->get('itemAuthor')): ?>
	              	 ,
	              	 <?php endif; ?>
	              	 
	              	 <?php if($params->get('itemCategory')): ?>
	              	 <span><?php echo JText::_('K2_PUBLISHED_IN'); ?></span> <a href="<?php echo $this->item->category->link; ?>"><?php echo $this->item->category->name; ?></a>
	              	 <?php endif; ?>
	...
	<div class="item-content<?php if($condition_info): ?> has-info<?php else: ?> no-info<?php endif; ?><?php if($condition_meta): ?> has-meta<?php else: ?> no-meta<?php endif; ?>">
          ...
          <div class="itemBody"> 
                    ...
                    <?php if($params->get('itemAttachments')): ?>
                    <div class="itemLinks">
     	          ...
     	          <?php if($this->item->params->get('itemAuthorBlock') && empty($this->item->created_by_alias)):?>
     	                   ...
     	                   <img src="<?php echo $this->item->author->avatar; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($this->item->author->name); ?>" /> 
     	                    <?php endif; ?>
     	                              ...
     	                              <a class="abAuthorName" rel="author" href="<?php echo $this->item->author->link; ?>"><strong><?php echo $this->item->author->name; ?></strong></a> 
     	                              <?php if($params->get('itemAuthorDescription') && !empty($this->item->author->profile->description)):?>
     	                              <p><?php echo $this->item->author->profile->description; ?></p>
     	                              <?php endif; ?>
     	                              
     	                              <?php if(($params->get('itemAuthorURL') && !empty($this->item->author->profile->url)) || $params->get('itemAuthorEmail')):?>
     	                              <p>
