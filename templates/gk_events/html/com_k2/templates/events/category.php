...
<div id="k2Container" class="events <?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<?php if(
		...
		<div class="itemsCategory">
			...
			<h1> 
				...
				<?php if($this->params->get('catTitleItemCounter')) echo ' <sup>('.$this->pagination->total.')</sup>'; ?>
			</h1>
			<?php endif; ?>
		...
		<div class="itemListSubCategories">
			...
			<div class="subCategoryContainer<?php echo $lastContainer; ?>"<?php echo (count($this->subCategories)==1) ? '' : ' style="width:'.(number_format(100/$this->params->get('subCatColumns'), 1)-0.1).'%;"'; ?>>
				<div class="subCategory">
					...
					<a class="button" href="<?php echo $subCategory->link; ?>"> <?php echo JText::_('K2_VIEW_ITEMS'); ?> </a> 
				</div>
			</div>
